                ...
                <div class="col-md-6 col-sm-8">
                    ...
                    <div class="form-auth">
                        <form action="action/auth/login.php" method="post">
                            <div class="mb-3">
                                <label for="cred" class="form-label">Email or Username</label>
                                <input type="text" name="cred" id="cred" class="form-control" placeholder="Your email or Username..." required>
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" name="password" id="password" class="form-control" placeholder="Your password..." required>
                            </div>
                            <p>Don't have account? <a href="registration.php">come here!</a></p>
                            <button class="btnAuth" name="btnLogin">Login</button>
                        </form>
                    </div>
                </div>
            </div>
